...
void	init_colors();
void	init_help();
void	init_inv_t_name();
void	init_materials();
void	init_metal_array();
void	init_monsters();
void	init_names();
void	init_player();
void	init_potions();
...
void	init_sticks();
void	init_stones();
void	init_stones_array();
void	init_traps();
void	init_wood_array();
...
void	nameit(THING *obj, int type, char *which, struct obj_info *op, char *(*prfunc)(THING *));
void	new_level();
